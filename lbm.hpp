...
struct CommHelper
{
    ...
    CommHelper(MPI_Comm comm_)
    {
        ...
        printf("me=%d,px=%d,py=%d,pz=%d\n", me, px, py, pz);
        printf("me=%d,rx=%d,ry=%d,rz=%d\n", me, rx, ry, rz);
        // 6 faces
        ...
        printf("Me:%i MyNeibors: %i %i %i %i %i %i %i %i %i %i\n", me, left, right, up, down,front,back, leftup, leftdown, rightup, rightdown);

         printf("Me:%i MyNeibors: %i %i %i %i %i %i %i %i\n", me, backup, backdown, backright, backleft, frontup, frontdown, frontright, frontleft);

        printf("Me:%i MyNeibors: %i %i %i %i %i %i %i %i\n", me, frontleftup, frontrightup, frontleftdown, frontrightdown, backleftup, backleftdown, backrightup, backrightdown);
